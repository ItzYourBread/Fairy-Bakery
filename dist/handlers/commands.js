        ...
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    commandFiles = (0, fs_1.readdirSync)("./dist/commands/" + folder).filter(function (file) { return file.endsWith('.js'); });
                    _a = 0, commandFiles_1 = commandFiles;
                    _b.label = 2;
                case 2:
                    if (!(_a < commandFiles_1.length)) return [3, 6];
                    file = commandFiles_1[_a];
                    return [4, Promise.resolve().then(function () { return (0, tslib_1.__importStar)(require("../commands/" + folder + "/" + file)); })];
                case 3:
