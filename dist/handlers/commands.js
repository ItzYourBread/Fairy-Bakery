...
function loadCommands(client) {
        ...
        return tslib_1.__generator(this, function (_b) {
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4, (_c = "../commands/".concat(folder, "/").concat(file), Promise.resolve().then(function () { return tslib_1.__importStar(require(_c)); }))];
                case 3:
    ...
    setTimeout(function () {
        console.log(chalk_1.default.blueBright("[System] ".concat(commands.length, " commands is loaded")));
    }, 70000);
}
